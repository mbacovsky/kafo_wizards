  ...
  module HighLine
    class Wizard < AbstractWizard
      ...
      def initialize(header, options={})
        super
        default_renderers = {
          :abstract => KafoWizards::HighLine::AbstractRenderer.new,
          :string => KafoWizards::HighLine::StringRenderer.new,
          :button => KafoWizards::HighLine::ButtonRenderer.new,
          :boolean => KafoWizards::HighLine::BooleanRenderer.new,
          :password => KafoWizards::HighLine::PasswordRenderer.new,
          :string_or_file => KafoWizards::HighLine::StringOrFileRenderer.new,
          :selector => KafoWizards::HighLine::SelectorRenderer.new
        }
        @renderers = options.fetch(:renderers, default_renderers)
      end
