...
describe KafoWizards::HighLine::Wizard do
  ...
  describe 'renderers' do
    ...
    it 'has the default renderers set' do
      wizard.renderers.keys.must_include :string_or_file
      wizard.renderers.keys.must_include :string
      wizard.renderers.keys.must_include :abstract
      wizard.renderers.keys.must_include :password
      wizard.renderers.keys.must_include :button
      wizard.renderers.keys.must_include :boolean
      wizard.renderers.keys.must_include :selector
    end
  end
